...
export const MODULES: Module[] = [
...

  {
    ...
    exercises: [
      ...
      {
        type: 'video',
        title: "Vidéo 1 : Trouver les veines - la technique infirmière",
        description: "Une infirmière explique comment repérer et préparer les veines pour une ponction veineuse. Aucun sang visible. Tension des jambes pendant toute la durée.",
        src: 'https://www.youtube.com/watch?v=VYZXHU21TqQ',
        minWatchSeconds: 0,
        showTension: true,
      },
      {
        type: 'video',
        title: "Vidéo 2 : Prélèvement sanguin veineux - protocole complet",
        description: "Le protocole complet d'une prise de sang, de la préparation à la compresse finale. Exercice clé de ce module. Tension musculaire maintenue.",
        src: 'https://www.youtube.com/watch?v=ep8QGJ144V8',
        minWatchSeconds: 20,
        showTension: true,
      },
      {
        type: 'video',
        title: "Vidéo 3 : Hémocultures - plusieurs tubes, plus de sang",
        description: "Un prélèvement pour hémocultures : même technique que la prise de sang classique, mais avec plusieurs tubes. Plus de sang visible. C'est l'exposition la plus intense de ce module.",
        src: 'https://www.youtube.com/watch?v=8Nx9l6rXx3Q',
        minWatchSeconds: 30,
        showTension: true,
      },
      {
