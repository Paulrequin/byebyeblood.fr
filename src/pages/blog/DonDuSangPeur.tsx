      ...
      <article className={s.wrap}>
        ...
        <div className={s.cta}>
          ...
          <p className={s.ctaText}>
            Bye Bye Blood propose 9 modules progressifs pour aller de "je ne peux pas regarder du sang" à "je gère une prise de sang sans malaise". La première séance est gratuite.
          </p>
