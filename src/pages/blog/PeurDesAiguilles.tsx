      ...
      <article className={s.wrap}>
        ...
        <div className={s.cta}>
          ...
          <p className={s.ctaText}>
            9 modules qui combinent tension musculaire appliquée, exposition graduelle et ACT. Conçu pour la peur du sang et des aiguilles. La première séance est gratuite, sans image difficile.
          </p>
