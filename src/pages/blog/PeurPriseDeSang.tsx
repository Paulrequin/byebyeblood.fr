      ...
      <article className={s.wrap}>
        ...
        <div className={s.cta}>
          ...
          <p className={s.ctaText}>
            9 modules progressifs. Exposition graduelle, tension musculaire appliquée, principes ACT. La première séance est gratuite, sans engagement, sans image difficile.
          </p>
