  ...
  useEffect(() => {
    ...
    const breadcrumb = {
      ...
      itemListElement: [
        ...
        { '@type': 'ListItem', position: 3, name: 'Hémophobie : traitement et conseils', item: 'https://www.byebyeblood.fr/blog/hemophobie-traitement' },
      ],
    }
      ...
      <article className={s.wrap}>
        ...
        <div className={s.cta}>
          ...
          <p className={s.ctaText}>
            9 modules progressifs qui combinent tension musculaire appliquée, exposition graduelle et ACT. La première séance est gratuite. Pas d'image difficile au départ.
          </p>
